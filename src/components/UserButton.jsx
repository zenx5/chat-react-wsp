...
export default function UserButton({ currentUserId, user, onClick }) {
    ...
    const existChat =  useCallback( async (id) => {
    ...
    }, [conversations,currentUserId, user.id])
    ...
    },[conversations, user.id, existChat])
    ...
    return <button  className="flex flex-row gap-2 justify-between w-full px-5 text-gray-600 hover:text-blue-500 hover:bg-blue-300 py-1 rounded-full" onClick={handlerGo}>
